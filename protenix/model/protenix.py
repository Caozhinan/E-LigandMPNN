...
class Protenix(nn.Module):
        ...
        _configs.update(
            {
                ...
                "diffusion_chunk_size": (
                    self.configs.infer_setting.sample_diffusion_chunk_size #1
    ...
    def main_train_loop(
        ...
        with torch.no_grad():
            ...
            N_step_mini_rollout = self.configs.sample_diffusion["N_step_mini_rollout"] #20
        ...
        _, x_denoised, x_noise_level = autocasting_disable_decorator(
            ...
            z_trunk=z,
            N_sample=N_sample,
            diffusion_chunk_size=self.configs.diffusion_chunk_size, #4
        )
        pred_dict.update(
            {
